from tkinter import * #Importing Tkinter module (library is a collection of module used to create a GUI application)
...
#Creating Windows GUI - Frontend
#All the properties assigned to root.___ belong to tk
root = Tk()
#Assigning tk module to the root variable
root.geometry("400x350") #using root -> module called tk
root.title("Calc") #using the dot operator is for adding bulit in functions
root.configure(bg= "black")

#Now we are adding the heading -> hence we need to mention Root again
#Remember totle is for the title of the software. For Heading use Label(root, text = "")
#place helps the model to understand where to add this, hence we add it to head - now we can see it
heading = Label(root, text = "Hiral's Calculator", font=('arial',14,'bold'),bg="sky blue", fg = 'indigo')
heading.place(x=130,y=10)

#Now creating a variable called txt
equation = StringVar()
...
txt_frame = Frame(txt, bd=10, bg = "dark blue") #bd = broad dimension
